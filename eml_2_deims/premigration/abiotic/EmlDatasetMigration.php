...
class EmlDatasetMigration extends XMLMigration {
  ...
  public function __construct(array $arguments) {
   ...
   //    'associatedparties' => t('The dataset associated roles'),
        ...
        'dataTableRef' => t('The data sources associated with this dataset'),
...
//////////////////////////////////////////////////////
    ...
    drupal_get_path('module', 'eml_2_deims') . '/xml/abiotic/';
    ...
    $this->addFieldMapping('field_section')->defaultValue('Abiotic');
    ...
    $this->addFieldMapping('field_methods', 'methods')
        ->xpath('dataset/methods/methodStep/description/section/para/literalLayout');
...
//    ));
  ...
  public function prepareRow($row) {
    ...
    //  Datasource
    $row->dataTableRef = $this->getDataSource($row);

...
#General path 
mydir="/home/isangil/WWW/deims_knz/www/sites/default/modules/eml_2_deims/xml/nutrients"

# Get the names of XML files from the subfolder (abiotic, nutrients, etc)
xml_files="${mydir}/*.xml"
...
for f in $xml_files
 ...
 do 
  ...
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/nutrients/EmlFileMigration.php 1> ./migration/EmlFileMigration.php

  # EmlDataFile Class 
  # Replace the name of eml in the class file 'EMLDataFile.php' by the eml file name extracted from directory 
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/nutrients/EmlDataFileMigration.php 1> ./migration/EmlDataFileMigration.php

  # EmlDataSet Class 
  # Replace the name of eml in the class file 'EMLDataSet' by the eml file name extracted from directory 
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/nutrients/EmlDatasetMigration.php 1> ./migration/EmlDatasetMigration.php

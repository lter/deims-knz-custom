...
//////////////////////////////////////////////////////
    ...
    drupal_get_path('module', 'eml_2_deims') . '/xml/met/';
    ...
    $this->addFieldMapping('field_section')->defaultValue('Meteorology');
...
//    ));
  ...
  public function prepareRow($row) {
    ...
    //  Datasource
    $row->xml->dataset->dataTable->entityName = $this->getDataSource($row);

    //  term
    $termid = 7;
    $row->xml->dataset->KeywordSet->keyword = $termid;

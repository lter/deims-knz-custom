...
#General path 
mydir="/home/isangil/WWW/deims_knz/www/sites/default/modules/eml_2_deims/xml/others"

# Get the names of XML files from the subfolder (producers, abiotic, etc)
xml_files="${mydir}/*.xml"
...
for f in $xml_files
 ...
 do 
  ...
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/others/EmlFileMigration.php 1> ./migration/EmlFileMigration.php

  # EmlDataFile Class 
  # Replace the name of eml in the class file 'EMLDataFile.php' by the eml file name extracted from directory 
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/others/EmlDataFileMigration.php 1> ./migration/EmlDataFileMigration.php

  # EmlDataSet Class 
  # Replace the name of eml in the class file 'EMLDataSet' by the eml file name extracted from directory 
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/others/EmlDatasetMigration.php 1> ./migration/EmlDatasetMigration.php

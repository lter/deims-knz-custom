...
/**
 * @file
 * Definition of SQLMigration.
 */
/**
 * Define the abstract SQL Migration group.
 */
abstract class SQLMigration extends Migration {
  ...
  public function __construct($group = NULL) {
    ...
    // in each - ensure the label is mssqlknzmeta
    $this->connection = Database::getConnection('default', 'mssqlknzmeta');

...
touch giseml_vector_processed.txt
...
for f in $xml_files
 ...
 do 
  ...
  # GisEMLFile Class 
  # Replace the name of eml in the class file 'GisEMLFile' by the gis vector eml file name extracted from directory 
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/vector/GisEmlFileMigration.php 1> ./migration/GisEmlFileMigration.php

  # GisEmlDataFile Class 
  # Replace the name of eml in the class file 'GisEMLDataFile' by the eml file name extracted from directory 
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/vector/GisEmlDataFileMigration.php 1> ./migration/GisEmlDataFileMigration.php

  # GisEmlDataSet Class 
  # Replace the name of eml in the class file 'GisEMLDataSet' by the gis vector eml file name extracted from directory 
  sed -e "s/oldemlfilename/$eml_file_name/" ./premigration/vector/GisEmlDatasetMigration.php 1> ./migration/GisEmlDatasetMigration.php
  ...
  echo "$eml_file_name.xml has been processed" >> giseml_vector_processed.txt 

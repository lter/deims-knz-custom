...
class GisEmlDataFileMigration extends XMLMigration {
  ...
  public function __construct(array $arguments) {
    ...
    $fields = array(
       'titlesrcname' => t('The title in GIS Vectorr archive'),
       'objectfilename' => t('The archive file name in GIS Vector EML'),
    ...
    // the xpath
    $item_xpath = '/eml:eml/dataset/spatialVector';  // relative to document
